    ...
    public static class TransformCSV2Model
    {
        ...
        private static BookedReductionsModel GetDObj(string item, BookedReductionsModel model)
        {
            ...
            var info = new Details(
                ...
                strArr[5],
                TryParseExtension.TryParseInt32(strArr[6], BookedReductionKLConstants.intDefault),
                TryParseExtension.TryParseDecimal(strArr[7], BookedReductionKLConstants.decimalDefault),
                TryParseExtension.TryParseDecimal(strArr[8], BookedReductionKLConstants.decimalDefault),
                TryParseExtension.TryParseDecimal(strArr[9], BookedReductionKLConstants.decimalDefault),
                strArr[10],
                strArr[11],
                strArr[12],
                strArr[13],
